...
@Configuration
@MapperScan(basePackages = "com.example.demo.mapper.slave",sqlSessionFactoryRef = "slaveSqlSessionFactory") //指定哪些包下的Mapper使用本数据源，并指定使用哪个SqlSessionFactory
public class SlaveMybatisConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("slave")DataSource dataSource) throws Exception {
        ...
        // 对应数据库的entity位置
        String typeAliasesPackage = "com.example.demo.entity.slave";
